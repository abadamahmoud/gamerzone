...
const  SideNav = () => {
  ...
  return (
    <nav className="flex fixed bottom-0 z-[500]   !bg-white dark:!bg-neutral-950 w-full md:relative md:w-auto md:h-full flex-col w- 20 flex-none lg:w-52 md:border-r px-3 py-4 md:px-2">
